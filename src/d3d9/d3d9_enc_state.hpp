...
// instead of a 10 KB full memcpy. NFS:MW heavy race: typical dirty
// mask is VS_CONST_F | PS_CONST_F | SAMPLER_STATES (~5 KB) vs the
...
//
// Total size: ~10 KB (down from 27 KB pre-compaction). NFS:MW
// gameplay sees ~200 unique POD clusters per frame; the compaction
