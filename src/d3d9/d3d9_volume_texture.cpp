...
MTLD3D9VolumeTexture::SetPriority(DWORD PriorityNew) {
  D9_TRACE("IDirect3DVolumeTexture9::SetPriority");
...
MTLD3D9VolumeTexture::GetPriority() {
  D9_TRACE("IDirect3DVolumeTexture9::GetPriority");
  return m_priority;
}

void STDMETHODCALLTYPE
MTLD3D9VolumeTexture::PreLoad() {
  D9_TRACE("IDirect3DVolumeTexture9::PreLoad");
}

D3DRESOURCETYPE STDMETHODCALLTYPE
MTLD3D9VolumeTexture::GetType() {
  D9_TRACE("IDirect3DVolumeTexture9::GetType");
  return D3DRTYPE_VOLUMETEXTURE;
}

DWORD STDMETHODCALLTYPE
MTLD3D9VolumeTexture::SetLOD(DWORD LODNew) {
  D9_TRACE("IDirect3DVolumeTexture9::SetLOD");
...
MTLD3D9VolumeTexture::GetLOD() {
  D9_TRACE("IDirect3DVolumeTexture9::GetLOD");
  return m_lod;
}

DWORD STDMETHODCALLTYPE
MTLD3D9VolumeTexture::GetLevelCount() {
  D9_TRACE("IDirect3DVolumeTexture9::GetLevelCount");
  return m_level_count;
}

HRESULT STDMETHODCALLTYPE
MTLD3D9VolumeTexture::SetAutoGenFilterType(D3DTEXTUREFILTERTYPE FilterType) {
  D9_TRACE("IDirect3DVolumeTexture9::SetAutoGenFilterType");
...
MTLD3D9VolumeTexture::GetAutoGenFilterType() {
  D9_TRACE("IDirect3DVolumeTexture9::GetAutoGenFilterType");
  return m_autoGenFilter;
}

void STDMETHODCALLTYPE
MTLD3D9VolumeTexture::GenerateMipSubLevels() {
  D9_TRACE("IDirect3DVolumeTexture9::GenerateMipSubLevels");
...
MTLD3D9VolumeTexture::UnlockBox(UINT Level) {
  ...
  // D3DLOCK_NO_DIRTY_UPDATE suppresses the implicit auto-record so
  // apps that AddDirtyBox manually after the lock get exactly their
  // explicit region. DXVK honours it the same way (`d3d9_device.cpp:
  // 5219`).
