...
// Rosetta x86_32 + WoW64 lives inside a 2-3 GB user VA ceiling
// (libMTLHud capture shows App Memory peaking at 1.49 GB). Each block
// is host RAM + Metal address-space registration + a pre-fault memset,
